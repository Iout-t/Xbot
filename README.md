...
First Run Setup
Open app → Grant overlay permission (Settings → Apps → Special Access → Display over other apps)
Open Accessibility Settings → Enable "AutomationApp Accessibility Service"
Grant MediaProjection permission when prompted
Grant SMS/Contacts permissions if using messaging features
Architecture
